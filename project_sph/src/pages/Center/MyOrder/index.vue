          ...
          <div class="order-content">
            ...
            <div class="orders">
              ...
              <table class="order-item" v-for="item in orderList.records" :key="item.id">
                ...
                <tbody>
                  <tr v-for="(info,index) in item.orderDetailList" :key="info.id">
                    <td width="60%">
                      <div class="typographic">
                        <img :src="info.imgUrl" style="width:100px;height:100px"> 
                        <a href="#" class="block-text">{{info.skuName}}</a>
                        <span>x{{info.skuNum}}</span>
