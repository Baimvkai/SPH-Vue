            ...
            <ul class="yui3-g">
              <li class="yui3-u-1-5" v-for="good in goodsList" :key="good.id">
                <div class="list-wrap">
                  ...
                  <div class="operate">
                    <a class="sui-btn btn-bordered btn-danger" @click="addShopcart(good.id,1)">加入购物车</a>
...
<script>
  ...
  export default {
    ...
    // 组件挂载完毕后执行一次
    mounted() {
      // 发请求之前代给服务器参数(searchParams参数发生变化)
      this.getData()
    },
    // 计算属性
    computed:{
      ...
      isOne(){
        // console.log(this.searchParams.order.indexOf('1'))
        return this.searchParams.order.indexOf('1') != -1
      },
      isTwo(){
        // console.log(this.searchParams.order.indexOf('2'));
    ...
    methods: {
      ...
      removeCategoryName(){
        // 把代给服务器的参数更新，重新发起请求
        // 将当前字段置为undefined，当前这个字段不会发送给服务器
        this.searchParams.categoryName = undefined
        this.searchParams.category1Id = undefined
        this.searchParams.category2Id = undefined
        this.searchParams.category3Id = undefined
        // 地址也需要跳转(现在的跳转到自己)
        // 本意时是删除query参数，params不应该删除
